...
A <- matrix(nrow=2, byrow=T, c(1447, 366, 201, 5, 9, 52, 280, 697,540, 108, 37, 2, 4, 12, 192, 289),
...
AA <- matrix(nrow=2, byrow=T, c(1447, 366, 201, 52, 280, 697,540, 108, 37, 12, 192, 289),
